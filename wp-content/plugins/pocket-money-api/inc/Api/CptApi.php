    ...
    */
    ...
    foreach ($tax_settings as $tax) {
      ...
      $this->tax_settings[] = [
        ...
        [$cpt_info['post_type']],
        [
          'label' => $tax['tax_title'] ?? esc_html__('Taxonomy Title', $this->plugin_slug),
          'hierarchical' => true,
          ...
          'labels' => [
            ...
            'all_items' => esc_html__('All', $this->plugin_slug) . $tax['tax_title'],
            'edit_item' => esc_html__('Edit', $this->plugin_slug) . ' ' . $tax['tax_title'],
            'view_item' => esc_html__('View', $this->plugin_slug) . ' ' . $tax['tax_title'],
            'update_item' => esc_html__('Update', $this->plugin_slug) . ' ' . $tax['tax_title'],
            'add_new_item' => esc_html__('Add New', $this->plugin_slug) . ' ' . $tax['tax_title'],
            'new_item_name' => esc_html__('New Title', $this->plugin_slug),
            'search_items' => esc_html__('Search', $this->plugin_slug) . ' ' . $tax['tax_title'],
            'popular_items' => esc_html__('Popular', $this->plugin_slug) . ' ' . $tax['tax_title'],
            'separate_items_with_commas' => esc_html__('Separate with comma', $this->plugin_slug),
            'choose_from_most_used' => esc_html__('Choose from most used', $this->plugin_slug) . ' ' . $tax['tax_title'],
            'not_found' => esc_html__('Nothing found', $this->plugin_slug),
          ]
        ]
      ];
    }
