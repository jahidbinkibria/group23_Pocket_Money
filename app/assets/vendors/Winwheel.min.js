function Winwheel(a, c) {
  defaultOptions = { canvasId: "canvas", centerX: null, centerY: null, outerRadius: null, innerRadius: 0, numSegments: 1, drawMode: "code", rotationAngle: 0, textFontFamily: "Arial", textFontSize: 20, textFontWeight: "bold", textOrientation: "horizontal", textAlignment: "center", textDirection: "normal", textMargin: null, textFillStyle: "black", textStrokeStyle: null, textLineWidth: 1, fillStyle: "silver", strokeStyle: "black", lineWidth: 1, clearTheCanvas: !0, imageOverlay: !1, drawText: !0, pointerAngle: 0, wheelImage: null, imageDirection: "N", responsive: !1, scaleFactor: 1 }
  for (var b in defaultOptions) this[b] = null != a && "undefined" !== typeof a[b] ? a[b] : defaultOptions[b]
  if (null != a) for (var d in a) "undefined" === typeof this[d] && (this[d] = a[d])
  this.canvasId ? ((this.canvas = document.getElementById(this.canvasId)) ? (null == this.centerX && (this.centerX = this.canvas.width / 2), null == this.centerY && (this.centerY = this.canvas.height / 2), null == this.outerRadius && (this.outerRadius = this.canvas.width < this.canvas.height ? this.canvas.width / 2 - this.lineWidth : this.canvas.height / 2 - this.lineWidth), (this.ctx = this.canvas.getContext("2d"))) : (this.ctx = this.canvas = null)) : (this.ctx = this.canvas = null)
  ...
  else if ("segmentImage" == this.drawMode) for (winwheelToDrawDuringAnimation = this, winhweelAlreadyDrawn = !1, b = 1; b <= this.numSegments; b++) null !== this.segments[b].image && ((this.segments[b].imgData = new Image()), (this.segments[b].imgData.onload = winwheelLoadedImage), (this.segments[b].imgData.src = this.segments[b].image))
}
...
Winwheel.prototype.drawPins = function () {
  if (this.pins && this.pins.number) {
    ...
    for (var t = 360 / this.pins.number, h = 1; h <= this.pins.number; h++) this.ctx.save(), (this.ctx.strokeStyle = this.pins.strokeStyle), (this.ctx.lineWidth = this.pins.lineWidth), (this.ctx.fillStyle = this.pins.fillStyle), this.ctx.translate(a, c), this.ctx.rotate(this.degToRad(h * t + this.rotationAngle)), this.ctx.translate(-a, -c), this.ctx.beginPath(), this.ctx.arc(a, c - b + d + e, d, 0, 2 * Math.PI), this.pins.fillStyle && this.ctx.fill(), this.pins.strokeStyle && this.ctx.stroke(), this.ctx.restore()
  }
}
    ...
    if (this.segments)
      for (var b = 1; b <= this.numSegments; b++) {
        ...
        if (d.imgData.height) {
          ...
          } else "E" == h ? ((h = a), (n = c - t / 2), (r = d.startAngle + 270 + (d.endAngle - d.startAngle) / 2)) : "W" == h ? ((h = a - e), (n = c - t / 2), (r = d.startAngle + 90 + (d.endAngle - d.startAngle) / 2)) : ((h = a - e / 2), (n = c - t), (r = d.startAngle + (d.endAngle - d.startAngle) / 2))
          this.ctx.save()
          this.ctx.translate(a, c)
    ...
    for (var a, c, b, d, e, t, h, n, r, f, l = this.centerX * this.scaleFactor, p = this.centerY * this.scaleFactor, w = this.outerRadius * this.scaleFactor, v = this.innerRadius * this.scaleFactor, y = 1; y <= this.numSegments; y++) {
      ...
      if (g.text) {
        ...
        for (f = 0; f < a.length; f++) {
          if ("reversed" == t)
            if ("horizontal" == d) (this.ctx.textAlign = "inner" == e ? "right" : "outer" == e ? "left" : "center"), (this.ctx.textBaseline = "middle"), (m = this.degToRad(g.endAngle - (g.endAngle - g.startAngle) / 2 + this.rotationAngle - 90 - 180)), this.ctx.save(), this.ctx.translate(l, p), this.ctx.rotate(m), this.ctx.translate(-l, -p), "inner" == e ? (n && this.ctx.fillText(a[f], l - v - h, p + b), r && this.ctx.strokeText(a[f], l - v - h, p + b)) : "outer" == e ? (n && this.ctx.fillText(a[f], l - w + h, p + b), r && this.ctx.strokeText(a[f], l - w + h, p + b)) : (n && this.ctx.fillText(a[f], l - v - (w - v) / 2 - h, p + b), r && this.ctx.strokeText(a[f], l - v - (w - v) / 2 - h, p + b)), this.ctx.restore()
            else if ("vertical" == d) {
              ...
              else if ("inner" == e) for (q = 0; q < a[f].length; q++) (u = a[f].charAt(q)), n && this.ctx.fillText(u, l + b, k), r && this.ctx.strokeText(u, l + b, k), (k += m)
              else if ("center" == e) for (k = 0, 1 < a[f].length && (k = (m * (a[f].length - 1)) / 2), k = p + v + (w - v) / 2 + k + h, q = a[f].length - 1; 0 <= q; q--) (u = a[f].charAt(q)), n && this.ctx.fillText(u, l + b, k), r && this.ctx.strokeText(u, l + b, k), (k -= m)
              this.ctx.restore()
            } else {
              if ("curved" == d)
                for (m = 0, "inner" == e ? ((m = v + h), (this.ctx.textBaseline = "top")) : "outer" == e ? ((m = w - h), (this.ctx.textBaseline = "bottom"), (m -= c * (a.length - 1))) : "center" == e && ((m = v + h + (w - v) / 2), (this.ctx.textBaseline = "middle")), k = 0, 1 < a[f].length ? ((this.ctx.textAlign = "left"), (k = (c / 10) * 4), (k *= 100 / m), (q = g.startAngle + ((g.endAngle - g.startAngle) / 2 - (k * a[f].length) / 2))) : ((q = g.startAngle + (g.endAngle - g.startAngle) / 2), (this.ctx.textAlign = "center")), q += this.rotationAngle, q -= 180, u = a[f].length; 0 <= u; u--) {
                  this.ctx.save()
                  var x = a[f].charAt(u)
                  this.ctx.translate(l, p)
          ...
          else if ("horizontal" == d) (this.ctx.textAlign = "inner" == e ? "left" : "outer" == e ? "right" : "center"), (this.ctx.textBaseline = "middle"), (m = this.degToRad(g.endAngle - (g.endAngle - g.startAngle) / 2 + this.rotationAngle - 90)), this.ctx.save(), this.ctx.translate(l, p), this.ctx.rotate(m), this.ctx.translate(-l, -p), "inner" == e ? (n && this.ctx.fillText(a[f], l + v + h, p + b), r && this.ctx.strokeText(a[f], l + v + h, p + b)) : "outer" == e ? (n && this.ctx.fillText(a[f], l + w - h, p + b), r && this.ctx.strokeText(a[f], l + w - h, p + b)) : (n && this.ctx.fillText(a[f], l + v + (w - v) / 2 + h, p + b), r && this.ctx.strokeText(a[f], l + v + (w - v) / 2 + h, p + b)), this.ctx.restore()
          else if ("vertical" == d) {
            this.ctx.textAlign = "center"
            ...
            "outer" == e ? (k = p - w + h) : "inner" == e && (k = p - v - h)
            m = c - c / 9
            if ("outer" == e) for (q = 0; q < a[f].length; q++) (u = a[f].charAt(q)), n && this.ctx.fillText(u, l + b, k), r && this.ctx.strokeText(u, l + b, k), (k += m)
            else if ("inner" == e) for (q = a[f].length - 1; 0 <= q; q--) (u = a[f].charAt(q)), n && this.ctx.fillText(u, l + b, k), r && this.ctx.strokeText(u, l + b, k), (k -= m)
            else if ("center" == e) for (k = 0, 1 < a[f].length && (k = (m * (a[f].length - 1)) / 2), k = p - v - (w - v) / 2 - k - h, q = 0; q < a[f].length; q++) (u = a[f].charAt(q)), n && this.ctx.fillText(u, l + b, k), r && this.ctx.strokeText(u, l + b, k), (k += m)
            this.ctx.restore()
          } else if ("curved" == d) for (m = 0, "inner" == e ? ((m = v + h), (this.ctx.textBaseline = "bottom"), (m += c * (a.length - 1))) : "outer" == e ? ((m = w - h), (this.ctx.textBaseline = "top")) : "center" == e && ((m = v + h + (w - v) / 2), (this.ctx.textBaseline = "middle")), k = 0, 1 < a[f].length ? ((this.ctx.textAlign = "left"), (k = (c / 10) * 4), (k *= 100 / m), (q = g.startAngle + ((g.endAngle - g.startAngle) / 2 - (k * a[f].length) / 2))) : ((q = g.startAngle + (g.endAngle - g.startAngle) / 2), (this.ctx.textAlign = "center")), q += this.rotationAngle, u = 0; u < a[f].length; u++) this.ctx.save(), (x = a[f].charAt(u)), this.ctx.translate(l, p), this.ctx.rotate(this.degToRad(q)), this.ctx.translate(-l, -p), r && this.ctx.strokeText(x, l, p - m + b), n && this.ctx.fillText(x, l, p - m + b), (q += k), this.ctx.restore()
          b += c
        }
      }
      this.ctx.restore()
...
Winwheel.prototype.deleteSegment = function (a) {
  if (1 < this.numSegments) {
    if ("undefined" !== typeof a) for (; a < this.numSegments; a++) this.segments[a] = this.segments[a + 1]
...
Winwheel.prototype.windowToCanvas = function (a, c) {
  ...
  return { x: Math.floor(a - (this.canvas.width / b.width) * b.left), y: Math.floor(c - (this.canvas.height / b.height) * b.top) }
}
...
function Pin(a) {
  var c = { visible: !0, number: 36, outerRadius: 3, fillStyle: "grey", strokeStyle: "black", lineWidth: 1, margin: 3, responsive: !1 },
    b
  for (b in c) this[b] = null != a && "undefined" !== typeof a[b] ? a[b] : c[b]
  if (null != a) for (var d in a) "undefined" === typeof this[d] && (this[d] = a[d])
}
function Animation(a) {
  var c = { type: "spinOngoing", direction: "clockwise", propertyName: null, propertyValue: null, duration: 10, yoyo: !1, repeat: null, easing: null, stopAngle: null, spins: null, clearTheCanvas: null, callbackFinished: null, callbackBefore: null, callbackAfter: null, callbackSound: null, soundTrigger: "segment" },
    b
  for (b in c) this[b] = null != a && "undefined" !== typeof a[b] ? a[b] : c[b]
  if (null != a) for (var d in a) "undefined" === typeof this[d] && (this[d] = a[d])
}
